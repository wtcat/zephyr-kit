...
{
    GX_WINDOW_MEMBERS_DECLARE
    GX_ICON status_window_icon_6;
    GX_ICON status_window_icon_7;
    GX_ICON_BUTTON status_window_icon_button;
    GX_ICON_BUTTON status_window_icon_button_1;
    GX_ICON_BUTTON status_window_icon_button_2;
...
typedef struct ROOT_WINDOW_CONTROL_BLOCK_STRUCT
{
    ...
    GX_WINDOW root_window_window_1;
    GX_WINDOW root_window_window_child;
